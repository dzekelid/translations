...
created: "2018-08-26"
modified: "2018-08-26"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/translations/master/_listings/sap/apis.md
...
- name: SAP Translation Hub - Languages that SAP Translation Hub supports.
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/translations/master/_listings/sap/languages-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/translations/master/_listings/sap/languages-get-openapi.md
- name: SAP Translation Hub - Returns a list of the text types available in SAP Translation
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/translations/master/_listings/sap/texttypes-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/translations/master/_listings/sap/texttypes-get-openapi.md
- name: SAP Translation Hub - Languages that SAP Translation Hub supports.
  x-api-slug: languages-get
  description: Returns a list of the languages that SAP Translation Hub supports.
    You can also check whether a particualr language is available in SAP Translation
